<template>
  <div class="bg-light-100 rounded p-2 shadow">
    <div class="flex justify-center">
      <img src="/img/627.png" class="w-ful rounded-full border" alt="" />
    </div>
    <ul>
      <li>
    ...
    <ul>
      <li class="mt-2">
        ...
        >
          <ArchiveIcon class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
          My Account
        </NuxtLink>
      </li>
    ...
    <ul v-if="selectedRole === roles[0]">
      <li class="mt-2">
        <NuxtLink
          ...
          class="text-gray-900 group flex w-full items-center rounded-md px-2 py-2 text-sm hover:(bg-black bg-opacity-5)"
        >
          <BookOpenIcon class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
          My Orders
        </NuxtLink>
      </li>
      <li class="mt-2">
    ...
    <ul v-if="selectedRole === roles[2]">
      <li class="mt-2">
        <NuxtLink
          ...
          class="text-gray-900 group flex w-full items-center rounded-md px-2 py-2 text-sm hover:(bg-black bg-opacity-5)"
        >
          <TruckIcon class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
          My Tranports
        </NuxtLink>
      </li>
      <li class="mt-2">
