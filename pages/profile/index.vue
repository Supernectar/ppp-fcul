        ...
        <form v-on:submit.prevent class="col">
          ...
          <div class="mb-3">
            ...
            <input v-model="username" type="text"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              id="exampleInputAddress1" :placeholder="user.username" />
          ...
          <div class="mb-3">
            ...
            <input v-model="address" type="text"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              :class="calculateAddressClass" id="exampleInputAddress1" placeholder="address" />
          </div>
          ...
          <div class="mb-3">
            ...
            <input v-model="phone" type="text"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              :class="calculatePhoneClass" id="exampleInputPhone1" :placeholder="user.phone" />
          ...
          <div class="mb-3">
            ...
            <input v-model="nif" type="text"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              :class="calculateNIFClass" id="exampleInputNIF1" :placeholder="user.nif" />
          ...
          <div class="mb-3">
            ...
            <input v-model="password" type="password"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              :class="calculatePasswordClass" id="exampleInputPassword1" placeholder="*********" />
